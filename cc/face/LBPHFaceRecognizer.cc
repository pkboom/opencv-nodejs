...
public:
  ...
  bool unwrapOptionalArgs(Nan::NAN_METHOD_ARGS_TYPE info) {
    return (
        FF::IntConverter::optArg(0, &radius, info) || FF::IntConverter::optArg(1, &neighbors, info) || FF::IntConverter::optArg(2, &grid_x, info) || FF::IntConverter::optArg(3, &grid_y, info) || FF::DoubleConverter::optArg(4, &threshold, info));
  }
